...
namespace ModelParametersTests
{
    ...
    public class ModelParametersTests
    {
       ...
       public void SetSeatThickness_NegativeTest(int Thickness)
        ...
        [TestCase(0, TestName = "Негативный тест установки ширины связи со значением 0")]
        [TestCase(0, TestName = "Негативный тест установки ширины связи со значением 0")]
        ...
        [TestCase(40, TestName = "Позитивный тест установки ширины связи со значением 40")]
        [TestCase(100, TestName = "Позитивный тест установки ширины связи со значением 100")]
        ...
        [TestCase(40, 40, TestName = "Позитивный тест установки высоты связи со значением 40")]
        [TestCase(100, 100, TestName = "Позитивный тест установки высоты связи со значением 100")]
        ...
        [TestCase(40, 45, TestName = "Негативный тест установки высоты связи со значением 45")]
        [TestCase(100, 110, TestName = "Негативный тест установки высоты связи со значением 110")]
        ...
        [TestCase(240, TestName = "Позитивный тест установки длины связи со значением 240")]
        [TestCase(320, TestName = "Позитивный тест установки длины связи со значением 320")]
        ...
        [TestCase(0, TestName = "Негативный тест установки длины связи со значением 0")]
        [TestCase(0, TestName = "Негативный тест установки длины связи со значением 0")]
        ...
        [TestCase(null, null, null, TestName = "Негативный тест для класса ChairParameters со значением null")]
